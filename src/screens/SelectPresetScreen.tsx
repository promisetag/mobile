...
const presets = [
  {
    id: 1,
    title: "Product One",
    image_url: require("../assets/images/samples/presets/asset-6.png"),
    tags: ["Superheroes", "Fitness", "Rides"],
  },
  {
    id: 2,
    title: "Product Two",
    image_url: require("../assets/images/samples/presets/asset-5.png"),
    tags: ["Pets"],
  },
  {
    id: 3,
    title: "Product Three",
    image_url: require("../assets/images/samples/presets/Nialaya-1.png"),
    tags: ["Pets", "Fitness", "Love", "Rides"],
  },
  {
    id: 4,
    title: "Product Four",
    image_url: require("../assets/images/samples/presets/collier-homme-avec-pendant-carte-de-poker-du-roi-1.png"),
